...
# Bad shots, 1002, 1003, 1014, 1025, ..., 1091, 1102, 1113, 1114, 1125, 1136, 1147
...
g, summary1, summary2 = adjoint_born(model, geometry.rec_positions, dpred.data[:], u=u0, is_residual=True, op_forward=opF, tsub_factor=12)
t2 = time.time()
