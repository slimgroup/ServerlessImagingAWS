...
ax.errorbar(num_cores_no_ht[0:6], np.mean(speedup2_no_ht[0:6,:]/N1, axis=1), fmt='o-', capsize=4)
ax.errorbar(num_cores_no_ht[0:6], np.mean(speedup2_ec2[0:6,:]/N1, axis=1), fmt='o-', capsize=4)
ax.errorbar(num_cores_optimum[0:5], np.mean(speedup2_optimum[0:5,:]/N2, axis=1), fmt='o-', capsize=4)
#ax.yaxis.set_major_formatter(NullFormatter())
#ax.yaxis.set_minor_formatter(NullFormatter())
plt.xticks(np.array([1,2,4,8,10,16,24]), ('1', '2', '4', '8', '10', '16', '24'), size=10)
#plt.yticks(np.array([1,2,4,8]), ('1', '2', '4', '8'), size=10)
ax.set_xlabel('No. of OMP threads', fontsize=10)
...
ax.errorbar(num_cores_no_ht[0:6], np.mean(kernel_time_no_ht[0:6,:], axis=1), fmt='o-', capsize=4)
ax.errorbar(num_cores_no_ht[0:6], np.mean(kernel_time_ec2[0:6,:], axis=1), fmt='o-', capsize=4)
ax.errorbar(num_cores_optimum[0:5], np.mean(kernel_time_optimum[0:5,:], axis=1), fmt='o-', capsize=4)
ax.set_xlabel('No. of OMP threads', fontsize=10)
