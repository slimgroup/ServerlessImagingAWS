...
ax.errorbar(num_instances, np.mean(speedup5_r5_metal, axis=1), fmt='o-', capsize=4)
ax.errorbar(num_instances, np.mean(speedup5_c5n, axis=1), fmt='o-', capsize=4)
ax.errorbar(num_instances, np.mean(speedup5_c5n_metal, axis=1), fmt='o-', capsize=4)
...
ax.errorbar(num_instances, np.mean(kernel_runtime_r5_metal, axis=1), fmt='o-', capsize=4)
ax.errorbar(num_instances, np.mean(kernel_runtime_c5n, axis=1), fmt='o-', capsize=4)
ax.errorbar(num_instances, np.mean(kernel_runtime_c5n_metal, axis=1), fmt='o-', capsize=4)
plt.xticks(num_instances, ('1', '2', '4', '8', '16'), size=10)
...
ax.errorbar(num_instances, np.mean(container_runtime_c5n, axis=1), fmt='o-', capsize=4)
ax.errorbar(num_instances, np.mean(script_runtime_c5n, axis=1), fmt='o-', capsize=4)
ax.errorbar(num_instances, np.mean(kernel_runtime_c5n, axis=1), fmt='o-', capsize=4)
plt.xticks(num_instances, ('1', '2', '4', '8', '16'), size=10)
